                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="radio" id="nam" value="Nam" name="gioi_tinh" <?php
                            ...
                            <input type="radio" id="nu" value="Nữ" name="gioi_tinh" <?php
                                                                                        if (isset($_POST['gioi_tinh'])) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="radio" id="van_phong" value="van_phong" name="loai_nhan_vien" <?php
                                                                                                        if (isset($_POST['loai_nhan_vien'])) {
                                                                                                            if ($_POST['loai_nhan_vien'] == 'van_phong') {
                                                                                                                echo 'checked="true"';
                                                                                                            }
                        ...
                        <td colspan="2">
                            ...
                            <input type="radio" id="san_xuat" value="san_xuat" name="loai_nhan_vien" <?php
                                                                                                        if (isset($_POST['loai_nhan_vien'])) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="radio" id="co" value="1" name="tang_ca" <?php
                            ...
                            <input type="radio" id="khong" value="0" name="tang_ca" <?php
                                                                                    if (isset($_POST['tang_ca'])) {
                                                                                        if ($_POST['tang_ca'] === '0') {
                                                                                            echo 'checked="true"';
                                                                                        }
